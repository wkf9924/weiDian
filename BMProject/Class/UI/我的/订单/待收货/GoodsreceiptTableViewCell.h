...
@interface GoodsreceiptTableViewCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UIButton *confirmreceiptbut;
@property (weak, nonatomic) IBOutlet UIButton *logisticsbut;
