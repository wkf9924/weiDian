...
//
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSString *)orderNo orderPrice:(NSString*)orderPrice orderName:(NSString *)orderName notifyUrl:(NSString *)notifyUrl
{

    //订单标题，展示给用户
    NSString *order_name    = orderName;
    //订单金额,单位（分）
    NSString *order_price   = orderPrice;
    //订单号
    NSString *order_no   = orderNo;
